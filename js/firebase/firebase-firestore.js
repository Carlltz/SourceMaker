...
function isBrowserExtension() {
  const runtime =
    typeof chrome === "object" ? chrome.runtime : typeof browser === "object" ? browser.runtime : undefined;
  ...
  return Fa$1(function () {
    ...
    for (let h = 0; 0 == a && h < d; h++) {
      ...
      do {
        ...
        a =
          ua$1(0 == e[1].length ? 0 : parseInt(e[1], 10), 0 == f[1].length ? 0 : parseInt(f[1], 10)) ||
...
function ib(a, b, c, d, e, f) {
  ...
  d.src = a;
  d.listener = c;
  if (a.addEventListener) Va$1 || (e = h), void 0 === e && (e = !1), a.addEventListener(b.toString(), d, e);
    ...
    ((d = p(d) ? !!d.capture : !!d), (c = hb(c)), a && a[B$1])
      ? ((a = a.i),
        ...
        b in a.g &&
          ((f = a.g[b]),
          (c = ab(f, c, d, e)),
          -1 < c && (Za$1(f[c]), Array.prototype.splice.call(f, c, 1), 0 == f.length && (delete a.g[b], a.h--))))
      : a &&
        (a = jb(a)) &&
        ((b = a.g[b.toString()]), (a = -1), b && (a = ab(b, c, d, e)), (c = -1 < a ? b[a] : null) && ob(c));
}
function ob(a) {
...
function kc$1(a, b) {
  ...
  b = a.H ? ya$1(a.H) : {};
  a.s
    ? (a.u || (a.u = "POST"), (b["Content-Type"] = "application/x-www-form-urlencoded"), a.g.ea(a.A, a.u, a.s, b))
        ...
        if (!(3 > r) && (3 != r || Ja$1 || (this.g && (this.h.h || this.g.ga() || oc$1(this.g))))) {
          ...
          if (this.i) {
            if (this.$ && !this.J) {
              ...
              if ((c = m))
                F$1(this.j, this.m, c, "Initial handshake response via X-HTTP-Initial-Response"),
                  (this.J = !0),
                  sc$1(this, c);
              else {
                this.i = !1;
            ...
            this.U
              ? (tc$1(this, r, h), Ja$1 && this.i && 3 == r && (Kb(this.V, this.W, "tick", this.fb), this.W.start()))
              : (F$1(this.j, this.m, h, null), sc$1(this, h));
            4 == r && P(this);
            this.i && !this.I && (4 == r ? uc$1(this.l, this) : ((this.i = !1), lc$1(this)));
          } else
            400 == c && 0 < h.indexOf("Unknown SID") ? ((this.o = 3), J$1(12)) : ((this.o = 0), J$1(13)),
              P(this),
              rc$1(this);
        }
      }
  ...
  d
    ? 0 < c.length &&
      ...
      b.g == a &&
        b.$ &&
        !b.L &&
        (b.h.info("Great, no buffering proxy detected. Bytes received: " + c.length), wc$1(b), (b.L = !0), J$1(11)))
...
k$1.eb = function () {
  ...
  const a = Date.now();
  0 <= a - this.Y
    ? (Qb(this.j, this.A), 2 != this.K && (I(3), J$1(17)), P(this), (this.o = 2), rc$1(this))
    : xc$1(this, this.Y - a);
};
function rc$1(a) {
          ...
          if (2 == c.G)
            if ("c" == m[0]) {
              ...
              null != Da &&
                "number" === typeof Da &&
                0 < Da &&
                ((d = 1.5 * Da), (c.K = d), c.h.info("backChannelRequestTimeoutMs_=" + d));
              d = c;
              const ca = a.g;
              if (ca) {
                ...
                if (Ea) {
                  ...
                  !f.g &&
                    ...
                    ((f.j = f.l), (f.g = new Set()), f.h && (Dc$1(f, f.h), (f.h = null)));
                }
                if (d.D) {
...
function S$1(a, b) {
  ...
  if (1 < c) {
    ...
    if (a instanceof S$1) for (c = a.T(), d = 0; d < c.length; d++) this.set(c[d], a.get(c[d]));
...
function Uc$1(a, b, c) {
  return "string" === typeof a
    ? ((a = encodeURI(a).replace(b, cd)), c && (a = a.replace(/%25([0-9a-fA-F]{2})/g, "%$1")), a)
    : null;
}
function cd(a) {
  a = a.charCodeAt(0);
...
k$1.R = function (a) {
  V(this);
  var b = [];
  if ("string" === typeof a) ed(this, a) && (b = qa$1(b, this.g.get(W$1(this, a))));
  else {
    a = this.g.R();
...
function gd(a) {
  ...
  l.PerformanceNavigationTiming
    ? ((a = l.performance.getEntriesByType("navigation")),
      (a = 0 < a.length && ("hq" == a[0].nextHopProtocol || "h2" == a[0].nextHopProtocol)))
...
k$1.pa = function () {
  "undefined" != typeof goog &&
    this.g &&
    ((this.j = "Timed out after " + this.B + "ms, aborting"), (this.m = 8), D$1(this, "timeout"), this.abort(8));
};
function zd(a, b) {
  a.h = !1;
...
function Y$1(a, b) {
  ...
  (b = b && b.httpSessionIdParam) &&
    !sa$1(b) &&
    ((this.g.D = b), (a = this.h), null !== a && b in a && ((a = this.h), b in a && delete a[b]));
  this.j = new Z$1(this);
}
t(Y$1, C$1);
    ...
    return (
      ...
      this.auth
        ? this.auth.getToken(e).then((e) =>
            ...
            this.i !== t
              ? ($("FirebaseAuthCredentialsProvider", "getToken aborted due to token change."), this.getToken())
              : e
              ? (B("string" == typeof e.accessToken), new W(e.accessToken, this.currentUser))
              : null
          )
...
class Z {
  ...
  getToken() {
    ...
    return (
      (this.forceRefresh = !1),
      this.appCheck
        ? this.appCheck.getToken(t).then((t) => (t ? (B("string" == typeof t.token), new X(t.token)) : null))
        : Promise.resolve(null)
    );
  }
  invalidateToken() {
...
class et {
  constructor(t, e) {
    (this.previousValue = t),
      e && ((e.sequenceNumberHandler = (t) => this.p(t)), (this.T = (t) => e.writeSequenceNumber(t)));
  }
  p(t) {
 ...
 */ class _t extends ft {
  ...
  canonicalString() {
    return this.toArray()
      .map(
        (t) => ((t = t.replace(/\\/g, "\\\\").replace(/`/g, "\\`")), _t.isValidIdentifier(t) || (t = "`" + t + "`"), t)
      )
      .join(".");
  }
  toString() {
   ...
   */ static fromServerFormat(t) {
    ...
    for (; s < t.length; ) {
      ...
      if ("\\" === e) {
        ...
        const e = t[s + 1];
        if ("\\" !== e && "." !== e && "`" !== e)
          throw new j(K.INVALID_ARGUMENT, "Path has invalid escape sequence: " + t);
        (n += e), (s += 2);
 ...
 */ function At(t) {
  ...
  return (
    "server_timestamp" ===
    (null ===
      (n = ((null === (e = null == t ? void 0 : t.mapValue) || void 0 === e ? void 0 : e.fields) || {}).__type__) ||
    void 0 === n
      ? void 0
      : n.stringValue)
  );
...
function Ft(t) {
  return "nullValue" in t
    ...
    ? t.stringValue
    : "bytesValue" in t
    ? It(t.bytesValue).toBase64()
    : "referenceValue" in t
    ? ((n = t.referenceValue), St.fromName(n).toString())
    : "geoPointValue" in t
  ...
  if (null === e.R) {
    ...
    null !== e.collectionGroup && (t += "|cg:" + e.collectionGroup),
      ...
      (t += e.orderBy
        ...
        .join(",")),
      bt(e.limit) || ((t += "|l:"), (t += e.limit)),
      e.startAt && ((t += "|lb:"), (t += he(e.startAt))),
      e.endAt && ((t += "|ub:"), (t += he(e.endAt))),
      (e.R = t);
  }
  return e.R;
}
  ...
  return (
    ...
    t.orderBy.length > 0 &&
      (e += `, orderBy: [${t.orderBy
        ...
        .join(", ")}]`),
    t.startAt && (e += ", startAt: " + he(t.startAt)),
    t.endAt && (e += ", endAt: " + he(t.endAt)),
    `Target(${e})`
  );
}
...
function Yt(t, e) {
  ...
  for (let i = 0; i < t.filters.length; i++)
    if (((n = t.filters[i]), (s = e.filters[i]), n.op !== s.op || !n.field.isEqual(s.field) || !Ct(n.value, s.value)))
      return !1;
  var n, s;
  return (
    t.collectionGroup === e.collectionGroup &&
    !!t.path.isEqual(e.path) &&
    !!we(t.startAt, e.startAt) &&
    we(t.endAt, e.endAt)
  );
}
...
class Zt extends class {} {
  ...
  matches(t) {
    ...
    return "!=" /* NOT_EQUAL */ === this.op
      ? null !== e && this.v(kt(e, this.value))
      : null !== e && Dt(this.value) === Dt(e) && this.v(kt(e, this.value));
 ...
 */ function Ae(t) {
  ...
  if (null === e.S) {
    ...
    if (null !== t && null === n)
      ...
      t.isKeyField() || e.S.push(new le(t)), e.S.push(new le(_t.keyField(), "asc" /* ASCENDING */));
    else {
      let t = !1;
      ...
      if (!t) {
        ...
        // explicit order by
        const t =
          e.explicitOrderBy.length > 0 ? e.explicitOrderBy[e.explicitOrderBy.length - 1].dir : "asc"; /* ASCENDING */
 ...
 */ function Re(t) {
  ...
  if (!e.D)
    if ("F" /* First */ === e.limitType)
      ...
      const n = e.endAt ? new ue(e.endAt.position, !e.endAt.before) : null,
        s = e.startAt ? new ue(e.startAt.position, !e.startAt.before) : null;
...
function ze(t, e) {
  return (
    ...
    (function (t, e) {
      return (t instanceof Be && e instanceof Be) || (t instanceof qe && e instanceof qe)
        ? rt(t.elements, e.elements, Ct)
        : t instanceof je && e instanceof je
        ? Ct(t.N, e.N)
        : t instanceof Le && e instanceof Le;
  ...
  t instanceof rn
    ? (function (t, e, n) {
        ...
        const s = t.value.clone(),
          i = cn(t.fieldTransforms, e, n.transformResults);
    ...
    ? (function (t, e, n) {
        ...
        const s = cn(t.fieldTransforms, e, n.transformResults),
          i = e.data;
 ...
 */ function tn(t, e, n) {
  t instanceof rn
    ...
    ? (function (t, e, n) {
        ...
        const s = un(t.fieldTransforms, n, e),
          i = e.data;
...
function nn(t, e) {
  return (
    ...
    (0 /* Set */ === t.type
      ...
      : 1 /* Patch */ !== t.type || (t.data.isEqual(e.data) && t.fieldMask.isEqual(e.fieldMask)))
  );
}
 ...
 *     Code.UNKNOWN.
 */ ((wn = dn || (dn = {}))[(wn.OK = 0)] = "OK"),
  (wn[(wn.CANCELLED = 1)] = "CANCELLED"),
  (wn[(wn.UNKNOWN = 2)] = "UNKNOWN"),
  (wn[(wn.INVALID_ARGUMENT = 3)] = "INVALID_ARGUMENT"),
  (wn[(wn.DEADLINE_EXCEEDED = 4)] = "DEADLINE_EXCEEDED"),
  (wn[(wn.NOT_FOUND = 5)] = "NOT_FOUND"),
  (wn[(wn.ALREADY_EXISTS = 6)] = "ALREADY_EXISTS"),
  (wn[(wn.PERMISSION_DENIED = 7)] = "PERMISSION_DENIED"),
  (wn[(wn.UNAUTHENTICATED = 16)] = "UNAUTHENTICATED"),
  (wn[(wn.RESOURCE_EXHAUSTED = 8)] = "RESOURCE_EXHAUSTED"),
  (wn[(wn.FAILED_PRECONDITION = 9)] = "FAILED_PRECONDITION"),
  (wn[(wn.ABORTED = 10)] = "ABORTED"),
  (wn[(wn.OUT_OF_RANGE = 11)] = "OUT_OF_RANGE"),
  (wn[(wn.UNIMPLEMENTED = 12)] = "UNIMPLEMENTED"),
  (wn[(wn.INTERNAL = 13)] = "INTERNAL"),
  (wn[(wn.UNAVAILABLE = 14)] = "UNAVAILABLE"),
  (wn[(wn.DATA_LOSS = 15)] = "DATA_LOSS");
...
class pn {
  constructor(t, e, n, s, i) {
    (this.key = t),
      (this.value = e),
      (this.color = null != n ? n : pn.RED),
      (this.left = null != s ? s : pn.EMPTY),
      (this.right = null != i ? i : pn.EMPTY),
...
function jn(t, e) {
  if (t.C) {
    return `${new Date(1e3 * e.seconds).toISOString().replace(/\.\d*/, "").replace("Z", "")}.${(
...
function is(t, e) {
  return "found" in e
    ? (function (t, e) {
        ...
        const n = Yn(t, e.found.name),
          s = Gn(e.found.updateTime),
          i = new jt({
            mapValue: {
...
function rs(t, e) {
  ...
  if ("targetChange" in e) {
    ...
    const s = (function (t) {
      ...
      r = (function (t, e) {
        return t.C
          ? (B(void 0 === e || "string" == typeof e), yt.fromBase64String(e || ""))
          : (B(void 0 === e || e instanceof Uint8Array), yt.fromUint8Array(e || new Uint8Array()));
    ...
    const i = Yn(t, s.document.name),
      r = Gn(s.document.updateTime),
      o = new jt({
        mapValue: {
          fields: s.document.fields,
        },
      }),
      a = Wt.newFoundDocument(i, r, o),
      c = s.targetIds || [],
    ...
    s.document;
    const i = Yn(t, s.document),
      r = s.readTime ? Gn(s.readTime) : ct.min(),
      o = Wt.newNoDocument(i, r),
  ...
  const n = e.currentDocument
    ...
    s = e.updateTransforms
      ? e.updateTransforms.map((e) =>
          (function (t, e) {
            let n = null;
            if ("setToServerValue" in e) B("REQUEST_TIME" === e.setToServerValue), (n = new Le());
...
function hs(t, e) {
  ...
  return (
    ...
    e.startAt && (n.structuredQuery.startAt = ws(e.startAt)),
    e.endAt && (n.structuredQuery.endAt = ws(e.endAt)),
    n
  );
}
...
function ds(t) {
  return t
    ? void 0 !== t.unaryFilter
      ...
      ? t.compositeFilter.filters.map((t) => ds(t)).reduce((t, e) => t.concat(e))
      : L()
    : [];
}
...
($s.store = "remoteDocuments"),
   ...
   */
  ($s.readTimeIndex = "readTimeIndex"),
  ($s.readTimeIndexPath = "readTime"),
  /**
   ...
   */
  ($s.collectionReadTimeIndex = "collectionReadTimeIndex"),
  ($s.collectionReadTimeIndexPath = ["parentPath", "readTime"]);
...
const js = [
    ...[
      ...[...[...[Ds.store, Cs.store, Ns.store, $s.store, Os.store, Ss.store, Ls.store, Ms.store], Us.store], Fs.store],
      Bs.store,
    ],
    qs.store,
    Ks.store,
...
class zs {
  ...
  abort(t) {
    t && this.It.reject(t),
      this.aborted ||
        ($("SimpleDb", "Aborting transaction:", t ? t.message : "Client-initiated abort"),
        (this.aborted = !0),
 ...
 */ class Hs {
   ...
   */ async Ct(t) {
    return (
      ...
      this.kt && (this.db.onversionchange = (t) => this.kt(t)),
      this.db
    );
  }
  xt(t) {
  ...
  async runTransaction(t, e, n, s) {
    ...
    for (;;) {
      ...
      try {
        ...
        const e = zs.open(this.db, t, i ? "readonly" : "readwrite", n),
          r = s(e)
            .catch(
              (t) => (
                // Abort the transaction if there was an error.
                e.abort(t), Gs.reject(t)
              )
            )
            .toPromise();
        ...
        if (($("SimpleDb", "Transaction failed with error:", t.message, "Retrying:", e), this.close(), !e))
 ...
 */ class Zs {
  ...
  put(t, e) {
    ...
    return (
      void 0 !== e
        ? ($("SimpleDb", "PUT", this.store.name, t, e), (n = this.store.put(e, t)))
        : ($("SimpleDb", "PUT", this.store.name, "<auto-key>", t), (n = this.store.put(t))),
      ti(n)
    );
  }
  /**
   ...
   */ get(t) {
    ...
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    return ti(this.store.get(t)).next(
      (e) => (
 ...
 */ class ri {
  ...
  isEqual(t) {
    return (
      ...
      rt(this.mutations, t.mutations, (t, e) => nn(t, e)) &&
      rt(this.baseMutations, t.baseMutations, (t, e) => nn(t, e))
    );
  }
}
...
/** Decodes a remote document from storage locally to a Document. */ function ui(t, e) {
  ...
  if (e.noDocument) {
    const t = St.fromSegments(e.noDocument.path),
      n = wi(e.noDocument.readTime),
      s = Wt.newNoDocument(t, n);
    return e.hasCommittedMutations ? s.setHasCommittedMutations() : s;
  }
  if (e.unknownDocument) {
    const t = St.fromSegments(e.unknownDocument.path),
      n = wi(e.unknownDocument.version);
...
/** Encodes a document for storage locally. */ function hi(t, e, n) {
  ...
  if (e.isFoundDocument()) {
    ...
    return new $s(/* unknownDocument= */ null, /* noDocument= */ null, n, r, s, i);
  }
  if (e.isNoDocument()) {
    const t = e.key.path.toArray(),
      n = di(e.version),
      r = e.hasCommittedMutations;
    return new $s(/* unknownDocument= */ null, new ks(t, n), /* document= */ null, r, s, i);
  }
  if (e.isUnknownDocument()) {
    const t = e.key.path.toArray(),
      n = di(e.version);
    return new $s(new xs(t, n), /* noDocument= */ null, /* document= */ null, /* hasCommittedMutations= */ !0, s, i);
  }
  return L();
}
...
function _i(t, e) {
  ...
  const s = e.mutations.map((e) => as(t.Gt, e)),
    i = at.fromMillis(e.localWriteTimeMs);
  return new ri(e.batchId, i, n, s);
}

/** Decodes a DbTarget into TargetData */ function mi(t) {
  const e = wi(t.readTime),
    n = void 0 !== t.lastLimboFreeSnapshotVersion ? wi(t.lastLimboFreeSnapshotVersion) : ct.min();
  let s;
  var i;
  return (
    void 0 !== t.query.documents
      ? (B(1 === (i = t.query).documents.length), (s = Re(ge(Zn(i.documents[0])))))
      : (s = (function (t) {
          return Re(ls(t));
        })(t.query)),
    new ai(s, t.targetId, 0 /* Listen */, t.lastListenSequenceNumber, e, n, yt.fromBase64String(t.resumeToken))
  );
}

/** Encodes TargetData into a DbTarget for storage locally. */ function gi(t, e) {
  const n = di(e.snapshotVersion),
    s = di(e.lastLimboFreeSnapshotVersion);
  let i;
 ...
 */ class Ai {
  ...
  add(t) {
    const e = t.lastSegment(),
      n = t.popLast(),
      s = this.index[e] || new Tn(dt.comparator),
      i = !s.has(n);
 ...
 */ class Ri {
  ...
  getCollectionParents(t, e) {
    const n = [],
      s = IDBKeyRange.bound([e, ""], [ot(e), ""], /*lowerOpen=*/ !1, /*upperOpen=*/ !0);
    return Pi(t)
      .Bt(s)
      .next((t) => {
        for (const s of t) {
...
/** A mutation queue for a specific user, backed by IndexedDB. */ (vi.DEFAULT_COLLECTION_PERCENTILE = 10),
  (vi.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT = 1e3),
  (vi.DEFAULT = new vi(41943040, vi.DEFAULT_COLLECTION_PERCENTILE, vi.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT)),
...
class Di {
  ...
  addMutationBatch(t, e, n, s) {
    ...
    return r.add({}).next((o) => {
      B("number" == typeof o);
      const a = new ri(o, e, n, s),
        c = (function (t, e, n) {
          const s = n.baseMutations.map((e) => os(t.Gt, e)),
            i = n.mutations.map((e) => os(t.Gt, e));
          return new Cs(e, n.batchId, n.localWriteTime.toMillis(), s, i);
        })(this.k, this.userId, a),
        u = [];
  ...
  getAllMutationBatches(t) {
    ...
    return Ni(t)
      .Bt(Cs.userMutationsIndex, e)
      .next((t) => t.map((t) => _i(this.k, t)));
  }
  getAllMutationBatchesAffectingDocumentKey(t, e) {
    // Scan the document-mutation index starting with a prefix starting with
    // the given documentKey.
    const n = Ns.prefixForPath(this.userId, e.path),
  ...
  getAllMutationBatchesAffectingDocumentKeys(t, e) {
    ...
    return (
      e.forEach((e) => {
        const i = Ns.prefixForPath(this.userId, e.path),
  ...
  getAllMutationBatchesAffectingQuery(t, e) {
    const n = e.path,
      s = n.length + 1,
      i = Ns.prefixForPath(this.userId, n),
      r = IDBKeyRange.lowerBound(i);
  ...
  removeMutationBatch(t, e) {
    return Vi(t.Wt, this.userId, e).next(
      (n) => (
        t.addOnCommittedListener(() => {
          this.ee(e.batchId);
        }),
  ...
  performConsistencyCheck(t) {
    return this.checkEmpty(t).next((e) => {
      ...
      // the queue is empty.
      const n = IDBKeyRange.lowerBound(Ns.prefixForUser(this.userId)),
        s = [];
      return ki(t)
        .jt(
          {
  ...
  ne(t) {
    return xi(t)
      .get(this.userId)
      .next((t) => t || new Ds(this.userId, -1, /*lastStreamToken=*/ ""));
  }
}
 ...
 */ function Ci(t, e, n) {
  const s = Ns.prefixForPath(e, n.path),
    i = s[1],
 ...
 */ class Fi {
  ...
  getLastRemoteSnapshotVersion(t) {
    return this.oe(t).next((t) =>
      ct.fromTimestamp(new at(t.lastRemoteSnapshotVersion.seconds, t.lastRemoteSnapshotVersion.nanoseconds))
    );
  }
  ...
  setTargetsMetadata(t, e, n) {
    return this.oe(t).next(
      (s) => (
        (s.highestListenSequenceNumber = e),
        n && (s.lastRemoteSnapshotVersion = n.toTimestamp()),
        e > s.highestListenSequenceNumber && (s.highestListenSequenceNumber = e),
        this.ae(t, s)
      )
    );
  }
  addTargetData(t, e) {
    return this.ce(t, e).next(() => this.oe(t).next((n) => ((n.targetCount += 1), this.ue(e, n), this.ae(t, n))));
  }
  ...
  removeTargetData(t, e) {
    return this.removeMatchingKeysForTargetId(t, e.targetId)
      .next(() => Oi(t).delete(e.targetId))
      .next(() => this.oe(t))
      .next((e) => (B(e.targetCount > 0), (e.targetCount -= 1), this.ae(t, e)));
  }
  /**
  ...
  containsKey(t, e) {
    const n = Rs(e.path),
      s = IDBKeyRange.bound([n], [ot(n)], /*lowerOpen=*/ !1, /*upperOpen=*/ !0);
    let i = 0;
    return Li(t)
      .jt(
        {
 ...
 */ class Ki {
  ...
  me(t) {
    ...
    $("LruGarbageCollector", `Garbage collection scheduled in ${e}ms`),
      (this._e = this.asyncQueue.enqueueAfterDelay("lru_garbage_collection" /* LruGarbageCollection */, e, async () => {
...
/** Implements the steps for LRU garbage collection. */ class ji {
  ...
  nthSequenceNumber(t, e) {
    ...
    const n = new qi(e);
    return this.ge
      .forEachTarget(t, (t) => n.de(t.sequenceNumber))
      .next(() => this.ge.pe(t, (t) => n.de(t)))
      .next(() => n.maxValue);
  }
  removeTargets(t, e, n) {
  ...
  collect(t, e) {
    return -1 === this.params.cacheSizeCollectionThreshold
      ? ($("LruGarbageCollector", "Garbage collection skipped; disabled"), Gs.resolve(bi))
  ...
  Te(t, e) {
    ...
    return this.calculateTargetCount(t, this.params.percentileToCollect)
      ...
      .next((e) => ((i = e), (c = Date.now()), this.removeOrphanedDocuments(t, n)))
      .next((t) => {
...
class Qi {
   ...
   */ Ae(t, e) {
    return (function (t, e) {
      let n = !1;
      return xi(t)
        .Qt((s) => Ci(t, s, e).next((t) => (t && (n = !0), Gs.resolve(!t))))
        .next(() => n);
    })(t, e);
  }
  removeOrphanedDocuments(t, e) {
 ...
 */ class Hi {
  ...
  getDocumentsMatchingQuery(t, e, n) {
    ...
    if (n.isEqual(ct.min())) {
      ...
      const t = e.path.toArray(),
        s = li(n);
      (r.range = IDBKeyRange.lowerBound([t, s], /* open= */ !0)), (r.index = $s.collectionReadTimeIndex);
    }
    return Xi(t)
      .jt(r, (t, n, r) => {
...
class Ji extends zi {
  ...
  applyChanges(t) {
    const e = [];
    let n = 0,
      s = new Tn((t, e) => it(t.canonicalString(), e.canonicalString()));
    return (
      ...
      e.push(this.De.updateMetadata(t, n)),
      Gs.waitFor(e)
    );
  }
  getFromCache(t, e) {
...
/** Performs database creation and schema upgrades. */ class tr {
   ...
   */ Nt(t, e, n, s) {
    ...
    return (
      ...
      n < 7 && s >= 7 && (r = r.next(() => this.xe(i))),
      n < 8 && s >= 8 && (r = r.next(() => this.$e(t, i))),
      n < 9 &&
        s >= 9 &&
        (r = r.next(() => {
  ...
  Ne(t) {
    ...
    return e.Bt().next((e) =>
      Gs.forEach(e, (e) => {
        ...
        return n.Bt(Cs.userMutationsIndex, s).next((n) =>
          Gs.forEach(n, (n) => {
            B(n.userId === e.userId);
            const s = _i(this.k, n);
        ...
        return n
          .jt((n, i) => {
            ...
            s.push(
              e
                .get(o)
                .next((n) => (n ? Gs.resolve() : ((n) => e.put(new Ms(0, Rs(n), t.highestListenSequenceNumber)))(r)))
            );
          })
          .next(() => Gs.waitFor(s));
      });
...
class sr {
  constructor(
    ...
    (this.referenceDelegate = new Qi(this, s)),
      (this.Ge = e + "main"),
      (this.k = new ci(a)),
      (this.ze = new Hs(this.Ge, 11, new tr(this.k))),
      (this.He = new Fi(this.referenceDelegate, this.k)),
      (this.Jt = new Ri()),
    ...
    return this.Ze()
      .then(() => {
        ...
        return (
          ...
          this.en(),
          this.nn(),
          this.runTransaction("getHighestListenSequenceNumber", "readonly", (t) => this.He.getHighestSequenceNumber(t))
        );
      })
      .then((t) => {
   ...
   */ Ze() {
    return this.runTransaction("updateClientMetadataAndTryBecomePrimary", "readwrite", (t) =>
      rr(t)
        .put(new Us(this.clientId, Date.now(), this.networkEnabled, this.inForeground))
        .next(() => {
          if (this.isPrimary)
        ...
        .next(() => this.on(t))
        .next((e) => (this.isPrimary && !e ? this.an(t).next(() => !1) : !!e && this.cn(t).next(() => !0)))
    )
      .catch((t) => {
        if (Xs(t))
        ...
        return (
          $("IndexedDbPersistence", "Releasing owner lease after error during lease refresh", t), /* isPrimary= */ !1
        );
      })
      .then((t) => {
   ...
   */ nn() {
    this.je = this.Oe.enqueueAfterDelay("client_metadata_refresh" /* ClientMetadataRefresh */, 4e3, () =>
      this.Ze()
        .then(() => this.ln())
        .then(() => this.nn())
    );
   ...
   */ on(t) {
    ...
    return ir(t)
      ...
      .next(
        (t) => (
          this.isPrimary !== t &&
            $("IndexedDbPersistence", `Client ${t ? "is" : "is not"} eligible for a primary lease.`),
          t
        )
      );
  }
  async shutdown() {
    ...
    (this.Ue = !1),
      this.mn(),
      this.je && (this.je.cancel(), (this.je = null)),
      this.gn(),
      this.yn(),
   ...
   */ Tn() {
    return this.runTransaction("getActiveClients", "readonly", (t) =>
      rr(t)
        .Bt()
        .next((t) => this.dn(t, 18e5).map((t) => t.clientId))
    );
  }
  get started() {
    return this.Ue;
  ...
  runTransaction(t, e, n) {
    ...
    return this.ze
      .runTransaction(
        ...
        js,
        (s) => (
          (i = new si(s, this.Be ? this.Be.next() : et.I)),
          "readwrite-primary" === e
            ? this.rn(i)
                .next((t) => !!t || this.on(i))
                .next((e) => {
                  if (!e)
                    throw (
                      ...
                      (this.isPrimary = !1),
                      this.Oe.enqueueRetryable(() => this.We(!1)),
  ...
  /** Checks the primary lease and removes it if we are the current primary. */ an(t) {
    ...
    return e
      .get(Ss.key)
      .next((t) =>
        this.un(t) ? ($("IndexedDbPersistence", "Releasing primary lease."), e.delete(Ss.key)) : Gs.resolve()
      );
  }
   ...
   */ en() {
    var t;
    "function" == typeof (null === (t = this.window) || void 0 === t ? void 0 : t.addEventListener) &&
      ((this.qe = () => {
        ...
        this.mn(),
          isSafari() &&
            ...
            this.Oe.enterRestrictedMode(/* purgeExistingTasks= */ !0),
 ...
 */ class cr {
  ...
  Dn(t, e, n) {
    ...
    let i = Pn();
    return this.Jt.getCollectionParents(t, s).next((r) =>
      Gs.forEach(r, (r) => {
        const o = (function (t, e) {
          return new _e(
            e,
  ...
  Cn(t, e, n) {
    ...
    return this.Je.getDocumentsMatchingQuery(t, e, n)
      .next((n) => ((s = n), this.An.getAllMutationBatchesAffectingQuery(t, e)))
      .next(
        (e) => (
          (i = e),
            ...
            for (const t of i)
              for (const e of t.mutations) {
                ...
                null == i &&
                  ...
                  ((i = Wt.newInvalidDocument(n)), (s = s.insert(n, i))),
                  tn(e, i, t.localWriteTime),
  ...
  Nn(t, e, n) {
    ...
    let i = n;
    return this.Je.getEntries(t, s).next(
      (t) => (
        t.forEach((t, e) => {
 ...
 */ class hr {
  ...
  /** Returns all local documents matching the specified query. */ getDocumentsMatchingQuery(t, e, n, s) {
    ...
    return (function (t) {
      return (
        ...
        null == t.startAt &&
        null == t.endAt &&
        (0 === t.explicitOrderBy.length || (1 === t.explicitOrderBy.length && t.explicitOrderBy[0].field.isKeyField()))
      );
    })(e) || n.isEqual(ct.min())
      ? this.Mn(t, e)
      : this.On.vn(t, s).next((i) => {
          const r = this.Ln(e, i);
          return (ye(e) || pe(e)) && this.Bn(e.limitType, r, s, n)
            ? this.Mn(t, e)
            : (k() <= LogLevel.DEBUG &&
                $("QueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), Ve(e)),
              this.On.getDocumentsMatchingQuery(t, e, n).next(
                (t) => (
  ...
  Mn(t, e) {
    return (
      k() <= LogLevel.DEBUG && $("QueryEngine", "Using full collection scan to execute query:", Ve(e)),
...
class lr {
  constructor(
    ...
    (this.persistence = t),
      ...
      (this.Wn = new cr(this.Qn, this.An, this.persistence.getIndexManager())),
  ...
  const r = await n.persistence.runTransaction("Handle user change", "readonly", (t) => {
    ...
    return n.An.getAllMutationBatches(t)
      .next(
        (o) => (
          (r = o),
          (s = n.persistence.getMutationQueue(e)),
          // Recreate our LocalDocumentsView using the new
          // MutationQueue.
          (i = new cr(n.Qn, s, n.persistence.getIndexManager())),
          s.getAllMutationBatches(t)
        )
      )
      .next((e) => {
        const n = [],
  ...
  return n.persistence
    .runTransaction("Apply remote event", "readwrite-primary", (t) => {
      ...
      e.targetChanges.forEach((e, r) => {
        ...
        o.push(
          n.He.removeMatchingKeys(t, e.removedDocuments, r).next(() => n.He.addMatchingKeys(t, e.addedDocuments, r))
        );
        ...
        if (c.approximateByteSize() > 0) {
          ...
          (i = i.insert(r, u)),
            ...
            (function (t, e, n) {
              ...
              u,
              e
            ) && o.push(n.He.updateTargetData(t, u));
        }
      });
      let a = An();
      ...
      // limbo.
      if (
        (e.documentUpdates.forEach((s, i) => {
          e.resolvedLimboDocuments.has(s) && o.push(n.persistence.referenceDelegate.updateLimboDocument(t, s));
        }),
        // Each loop iteration only affects its "own" doc, so it's safe to get all the remote
        // documents in advance in a single call.
        o.push(
          gr(t, r, e.documentUpdates, s, void 0).next((t) => {
            a = t;
          })
        ),
        !s.isEqual(ct.min()))
        ...
        const e = n.He.getLastRemoteSnapshotVersion(t).next((e) =>
          n.He.setTargetsMetadata(t, t.currentSequenceNumber, s)
        );
        o.push(e);
      }
      return Gs.waitFor(o)
        ...
        n.forEach((n, o) => {
          ...
          o.isNoDocument() && o.version.isEqual(ct.min())
            ...
            : !a.isValidDocument() ||
              ...
              (0 === o.version.compareTo(a.version) && a.hasPendingWrites)
...
function yr(t, e) {
  ...
  return n.persistence.runTransaction(
    ...
    "readonly",
    (t) => (void 0 === e && (e = -1), n.An.getNextMutationBatchAfterBatchId(t, e))
  );
}
...
function pr(t, e) {
  ...
  return n.persistence
    .runTransaction("Allocate target", "readwrite", (t) => {
      let s;
      return n.He.getTargetData(t, e).next((i) =>
        i
          ...
          : n.He.allocateTargetId(t).next(
              (i) => (
                (s = new ai(e, i, 0 /* Listen */, t.currentSequenceNumber)), n.He.addTargetData(t, s).next(() => s)
              )
            )
      );
    })
    .then((t) => {
      ...
      return (
        (null === s || t.snapshotVersion.compareTo(s.snapshotVersion) > 0) &&
          ((n.qn = n.qn.insert(t.targetId, t)), n.Kn.set(e, t.targetId)),
        t
      );
    });
}
      ...
      .next((e) => {
        if (e)
          return (
            ...
            s.He.getMatchingKeysForTargetId(t, e.targetId).next((t) => {
              r = t;
            })
          );
      })
      .next(() => s.Un.getDocumentsMatchingQuery(t, e, n ? i : ct.min(), n ? r : Sn()))
      .next((t) => ({
        documents: t,
        zn: r,
      }))
...
function Ir(t, e) {
  ...
  return i
    ...
    : n.persistence.runTransaction("Get target data", "readonly", (t) => s.Et(t, e).next((t) => (t ? t.target : null)));
}
...
async function Pr(t, e, n, s) {
  ...
  return i.persistence.runTransaction("Apply bundle documents", "readwrite", (t) =>
    gr(t, c, o, ct.min(), a)
      .next((e) => (c.apply(t), e))
      .next((e) =>
        i.He.removeMatchingKeysForTargetId(t, u.targetId)
          .next(() => i.He.addMatchingKeys(t, r, u.targetId))
          .next(() => i.Wn.Vn(t, e))
          .next(() => e)
      )
  );
...
async function br(t, e, n = Sn()) {
  ...
  const s = await pr(t, Re(yi(e.bundledQuery))),
    i = q(t);
  return i.persistence.runTransaction("Save named query", "readwrite", (t) => {
    ...
    return (
      (i.qn = i.qn.insert(o.targetId, o)),
      i.He.updateTargetData(t, o)
        .next(() => i.He.removeMatchingKeysForTargetId(t, s.targetId))
        .next(() => i.He.addMatchingKeys(t, n, s.targetId))
        .next(() => i.Ye.saveNamedQuery(t, e))
    );
  });
}
 ...
 */ class Vr {
   ...
   * removed.
   */ us(t) {
    const e = new St(new dt([])),
      n = new Sr(e, t),
      s = new Sr(e, t + 1),
      i = [];
    return (
      this.ns.forEachInRange([n, s], (t) => {
 ...
 */ class Dr {
  ...
  addMutationBatch(t, e, n, s) {
    ...
    for (const e of s)
      (this.ws = this.ws.add(new Sr(e.key, i))), this.Jt.addToCollectionParentIndex(t, e.key.path.popLast());
    return Gs.resolve(r);
  }
  lookupMutationBatch(t, e) {
  ...
  getAllMutationBatchesAffectingDocumentKey(t, e) {
    const n = new Sr(e, 0),
      s = new Sr(e, Number.POSITIVE_INFINITY),
      i = [];
    return (
      this.ws.forEachInRange([n, s], (t) => {
  ...
  getAllMutationBatchesAffectingDocumentKeys(t, e) {
    ...
    return (
      e.forEach((t) => {
        const e = new Sr(t, 0),
          s = new Sr(t, Number.POSITIVE_INFINITY);
...
class Cr {
   ...
   */ addEntry(t, e, n) {
    ...
    return (
      ...
      (this.size += o - r),
      this.Jt.addToCollectionParentIndex(t, s.path.popLast())
    );
  }
  /**
    ...
    return (
      this.changes.forEach((n, s) => {
        s.document.isValidDocument()
          ? e.push(this.De.addEntry(t, s.document, this.getReadTime(n)))
 ...
 */ class kr {
  ...
  ce(t) {
    ...
    const e = t.targetId;
    e > this.highestTargetId && ((this.Ps = new $i(e)), (this.highestTargetId = e)),
    ...
    return (
      this.Is.forEach((r, o) => {
        o.sequenceNumber <= e &&
          ...
          (this.Is.delete(r), i.push(this.removeMatchingKeysForTargetId(t, o.targetId)), s++);
      }),
      Gs.waitFor(i).next(() => s)
    );
  }
...
class xr {
  ...
  getMutationQueue(t) {
    ...
    return e || ((e = new Dr(this.Jt, this.referenceDelegate)), (this.bs[t.toKey()] = e)), e;
  }
  getTargetCache() {
    return this.He;
  }
  ...
  runTransaction(t, e, n) {
    ...
    return (
      ...
      n(s)
        .next((t) => this.referenceDelegate.Ss(s).next(() => t))
        .toPromise()
...
class Fr {
  ...
  $s(t, e) {
    return Gs.or([
      () => Gs.resolve(this.Cs.containsKey(e)),
...
class Br {
   ...
   */ static Fs(t, e, n) {
    ...
    return (
      r &&
        s.error &&
        ((r = "string" == typeof s.error.message && "string" == typeof s.error.code),
        r && (i = new j(s.error.code, s.error.message))),
      r
        ? new Br(t, e, s.state, i)
        : (F("SharedClientState", `Failed to parse mutation state for ID '${e}': ${n}`), null)
    );
  }
  Os() {
    const t = {
   ...
   */ static Fs(t, e) {
    ...
    return (
      i &&
        ...
        i && (s = new j(n.error.code, n.error.message))),
      i ? new Ur(t, n.state, s) : (F("SharedClientState", `Failed to parse target state for ID '${t}': ${e}`), null)
    );
  }
  Os() {
    const t = {
 ...
 */ class qr {
   ...
   */ static Fs(t, e) {
    ...
    for (let t = 0; s && t < n.activeTargetIds.length; ++t)
      (s = Vt(n.activeTargetIds[t])), (i = i.add(n.activeTargetIds[t]));
    return s ? new qr(t, i) : (F("SharedClientState", `Failed to parse client data for instance '${t}': ${e}`), null);
  }
}
 ...
 */ class Kr {
   ...
   */ static Fs(t) {
    ...
    return "object" == typeof e &&
      ...
      ? new Kr(e.clientId, e.onlineState)
 ...
 */ class Qr {
  constructor(t, e, n, s, i) {
    ...
    (this.storage = this.window.localStorage),
      (this.currentUser = i),
      (this.Qs = Or(this.persistenceKey, this.Bs)),
      (this.Ws =
      ...
      (this.Ks = this.Ks.insert(this.Bs, new jr())),
      (this.Gs = new RegExp(`^firestore_clients_${r}_([^_]*)$`)),
      (this.zs = new RegExp(`^firestore_mutations_${r}_(\\d+)(?:_(.*))?$`)),
      (this.Hs = new RegExp(`^firestore_targets_${r}_(\\d+)$`)),
      (this.Js =
  ...
  ni(t, e, n) {
    const s = new Br(this.currentUser, t, e, n),
  ...
  ri(t, e, n) {
    const s = Lr(this.persistenceKey, t),
      i = new Ur(t, e, n);
    this.setItem(s, i.Os());
  }
  ai() {
  ...
  ui(t, e) {
    const n = e ? this.Ks.insert(t, e) : this.Ks.remove(t),
      s = this.ei(this.Ks),
      i = this.ei(n),
      r = [],
      o = [];
    ...
    Bi(t, e, n, s, i) {
      ...
      return (
        ...
        this.Ki(t, r, o, n).then(
          (t) => ($("RestConnection", "Received: ", t), t),
          (e) => {
            throw (O("RestConnection", `${t} failed with error: `, e, "url: ", r, "request:", n), e);
          }
        )
      );
    }
  ...
  }
{
        ...
        try {
          switch (o.getLastErrorCode()) {
            ...
            case ErrorCode.HTTP_ERROR:
              const n = o.getStatus();
              if (
                ($("Connection", 'RPC "' + t + '" failed with status:', n, "response text:", o.getResponseText()),
                n > 0)
              ) {
  ...
  Qi(t, e, n) {
    const s = [this.Mi, "/", "google.firestore.v1.Firestore", "/", t, "/channel"],
    ...
    this.useFetchStreams && (o.xmlHttpFactory = new FetchXmlHttpFactory({})),
      this.qi(o.initMessageHeaders, e, n),
    ...
    const g = new Jr({
        Vi: (t) => {
          h
            ? $("Connection", "Not sending because WebChannel is closed:", t)
            : (u || ($("Connection", "Opening WebChannel transport."), c.open(), (u = !0)),
              $("Connection", "WebChannel sending:", t),
              c.send(t));
        },
        Si: () => c.close(),
      }),
    ...
    return (
      ...
      y(c, WebChannel.EventType.ERROR, (t) => {
        h ||
          ((h = !0),
          O("Connection", "WebChannel transport errored:", t),
          g.Fi(new j(K.UNAVAILABLE, "The operation could not be completed")));
      }),
      ...
      y(r, Event.STAT_EVENT, (t) => {
        t.stat === Stat.PROXY
          ? $("Connection", "Detected buffering proxy")
          : t.stat === Stat.NOPROXY && $("Connection", "Detected no buffering proxy");
      }),
      setTimeout(() => {
...
class eo {
   ...
   */ Zi(t) {
    ...
    s > 0 &&
      $(
        "ExponentialBackoff",
        `Backing off for ${s} ms (base delay: ${this.Hi} ms, delay with jitter: ${e} ms, last attempt: ${n} ms ago)`
      ),
      (this.Ji = this.Oe.enqueueAfterDelay(this.timerId, s, () => ((this.Yi = Date.now()), t()))),
    ...
    this.yr(),
      ...
      4 /* Error */ !== t
        ...
        ? // Log the error. (Probably either 'quota exceeded' or 'max queue length reached'.)
          (F(e.toString()), F("Using maximum backoff delay to prevent overloading the backend."), this.ur.Xi())
        : e &&
    ...
    (this.stream = this.Rr(t, e)),
      this.stream.Di(() => {
        n(
          () => (
            (this.state = 2) /* Open */,
            (this.cr = this.Oe.enqueueAfterDelay(
              this.sr,
              1e4,
              () => (this.lr() && (this.state = 3) /* Healthy */, Promise.resolve())
            )),
            this.listener.Di()
          )
        );
   ...
   */ Er(t) {
    return (e) => {
      this.Oe.enqueueAndForget(() =>
        this.rr === t
          ? e()
          : ($("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), Promise.resolve())
      );
    };
  }
}
      ...
      (e.addTarget = (function (t, e) {
        ...
        return (
          ...
          e.resumeToken.approximateByteSize() > 0
            ? (n.resumeToken = Qn(t, e.resumeToken))
            : e.snapshotVersion.compareTo(ct.min()) > 0 &&
              // TODO(wuandy): Consider removing above check because it is most likely true.
              // Right now, many tests depend on this behaviour though (leaving min() out
              // of serialization).
              (n.readTime = jn(t, e.snapshotVersion.toTimestamp())),
          n
        );
      })(this.k, t));
    const n = fs(this.k, t);
...
class ro extends class {} {
  constructor(t, e, n, s) {
    super(), (this.authCredentials = t), (this.appCheckCredentials = e), (this.ir = n), (this.k = s), (this.$r = !1);
  }
  Fr() {
...
class oo {
   ...
   */ Br() {
    0 === this.Or &&
      (this.Ur("Unknown" /* Unknown */),
      (this.Mr = this.asyncQueue.enqueueAfterDelay(
   ...
   */ Kr(t) {
    "Online" /* Online */ === this.state
      ...
      : (this.Or++,
        this.Or >= 1 &&
          (this.jr(),
          this.qr(`Connection failed 1 times. Most recent error: ${t.toString()}`),
          this.Ur("Offline" /* Offline */)));
  }
  /**
        ...
        n.enqueueAndForget(async () => {
          ...
          go(this) &&
            ...
            await (async function (t) {
              const e = q(t);
              e.Gr.add(4 /* ConnectivityChange */),
                await uo(e),
                e.Jr.set("Unknown" /* Unknown */),
                e.Gr.delete(4 /* ConnectivityChange */),
                await co(e);
            })(this));
        });
      }),
...
async function Eo(t, e, n) {
  if (
    ...
    try {
      ...
      $("RemoteStore", "Failed to remove targets %s: %s ", e.targetIds.join(","), n), await Io(t, n);
    }
  else if ((e instanceof xn ? t.Yr.ot(e) : e instanceof $n ? t.Yr.dt(e) : t.Yr.ut(e), !n.isEqual(ct.min())))
    try {
 ...
 */ async function Io(t, e, n) {
  ...
  t.Gr.add(1 /* IndexedDbFailed */),
    ...
    t.asyncQueue.enqueueRetryable(async () => {
      $("RemoteStore", "Retrying IndexedDB access"), await n(), t.Gr.delete(1 /* IndexedDbFailed */), await co(t);
    });
}
  ...
  e &&
    ...
    (await (async function (t, e) {
      ...
      if (((n = e.code), _n(n) && n !== K.ABORTED)) {
        ...
        // restart.
        $o(t).wr(),
          await Ao(t, () => t.remoteSyncer.rejectFailedWrite(n.batchId, e)),
...
async function ko(t, e) {
  const n = q(t);
  e
    ? (n.Gr.delete(2 /* IsSecondary */), await co(n))
    : e || (n.Gr.add(2 /* IsSecondary */), await uo(n), n.Jr.set("Unknown" /* Unknown */));
}
 ...
 */ function xo(t) {
  return (
    t.Xr ||
      ...
      t.zr.push(async (e) => {
        e ? (t.Xr.wr(), mo(t) ? _o(t) : t.Jr.set("Unknown" /* Unknown */)) : (await t.Xr.stop(), yo(t));
      })),
    t.Xr
  );
}
    ...
    t.Zr ||
      ...
      t.zr.push(async (e) => {
        e
          ...
          : (await t.Zr.stop(),
            t.Qr.length > 0 &&
              ($("RemoteStore", `Stopping write stream with ${t.Qr.length} pending writes`), (t.Qr = [])));
      })),
    t.Zr
  );
}
...
class Fo {
   ...
   */ cancel(t) {
    null !== this.timerHandle &&
      (this.clearTimeout(), this.deferred.reject(new j(K.CANCELLED, "Operation cancelled" + (t ? ": " + t : ""))));
  }
  handleDelayElapsed() {
...
class Bo {
  ...
  /** Returns a view snapshot as if all documents in the snapshot were added. */ static fromInitialDocuments(
    ...
    return (
      ...
      new Bo(t, e, Mo.emptySet(e), i, n, s, /* syncStateChanged= */ !0, /* excludesMetadataChanges= */ !1)
    );
  }
  get hasPendingWrites() {
...
class qo {
  constructor() {
    (this.queries = new Gi((t) => ve(t), be)), (this.onlineState = "Unknown") /* Unknown */, (this.io = new Set());
  }
}
 ...
 */ class zo {
   ...
   */ oo(t) {
    ...
    let e = !1;
    return (
      this.co ? this.ho(t) && (this.ao.next(t), (e = !0)) : this.lo(t, this.onlineState) && (this.fo(t), (e = !0)),
      (this.uo = t),
      e
    );
  }
  ...
  /** Returns whether a snapshot was raised. */ ro(t) {
    this.onlineState = t;
    let e = !1;
    return this.uo && !this.co && this.lo(this.uo, t) && (this.fo(this.uo), (e = !0)), e;
  }
  lo(t, e) {
  ...
  fo(t) {
    (t = Bo.fromInitialDocuments(t.query, t.docs, t.mutatedKeys, t.fromCache)), (this.co = !0), this.ao.next(t);
  }
}
 ...
 */ class Jo {
   ...
   */ Jn(t) {
    return t.metadata.exists
      ? ss(this.k, t.document, !1)
      : Wt.newNoDocument(this.Hn(t.metadata.name), this.Yn(t.metadata.readTime));
  }
  Yn(t) {
    return Gn(t);
  }
 ...
 */ class Yo {
   ...
   */ async complete() {
    const t = await Pr(this.localStore, new Jo(this.k), this.documents, this.mo.id),
      e = this.po(this.documents);
 ...
 */ class ea {
   ...
   */ bo(t, e) {
    ...
    const a = ye(this.query) && s.size === this.query.limit ? s.last() : null,
      c = pe(this.query) && s.size === this.query.limit ? s.first() : null;
    // Drop documents out to meet limit/limitToLast requirement.
    if (
      (t.inorderTraversal((t, e) => {
        const u = s.get(t),
          h = Se(this.query, e) ? e : null,
        ...
        if (u && h) {
          u.data.isEqual(h.data)
            ...
            : this.Vo(u, h) ||
              ...
              (d = !0),
              ((a && this.Ao(h, a) > 0) || (c && this.Ao(h, c) < 0)) &&
  ...
  applyChanges(t, e, n) {
    ...
    i.sort(
      ...
      this.So(n);
    const r = e ? this.Do() : [],
      o = 0 === this.Io.size && this.current ? 1 /* Synced */ : 0 /* Local */,
      a = o !== this.Eo;
   ...
   */ No(t) {
    ...
    return (
      ...
      !!this.Ro.has(t) &&
      !this.Ro.get(t).hasLocalMutations
    );
  }
  /**
...
async function ra(t, e) {
  ...
  if (r)
    ...
    const t = await pr(n.localStore, Re(e)),
 ...
 */ async function oa(t, e, n, s) {
  ...
  t.Go = (e, n, s) =>
    (async function (t, e, n, s) {
      ...
      i.Bn &&
        ...
        (i = await Er(t.localStore, e.query, /* usePreviousResults= */ !1).then(({ documents: t }) => e.view.bo(t, i)));
  ...
  const i = await Er(t.localStore, e, /* usePreviousResults= */ !0),
    r = new ea(e, i.zn),
    o = r.bo(i.documents),
    a = kn.createSynthesizedTargetChangeForCurrentChange(n, s && "Offline" /* Offline */ !== t.onlineState),
    c = r.applyChanges(o, /* updateLimboDocuments= */ t.isPrimaryClient, a);
  pa(t, n, c.Co);
...
/** Stops listening to the query. */ async function aa(t, e) {
  ...
  if (n.isPrimaryClient) {
    ...
    n.sharedClientState.isActiveQueryTarget(s.targetId) ||
      (await Tr(n.localStore, s.targetId, /*keepPersistedTargetData=*/ !1)
        .then(() => {
          n.sharedClientState.clearQueryState(s.targetId), lo(n.remoteStore, s.targetId), ga(n, s.targetId);
        })
        .catch(Bi));
  } else ga(n, s.targetId), await Tr(n.localStore, s.targetId, /*keepPersistedTargetData=*/ !0);
}
 ...
 */ async function ca(t, e, n) {
  ...
  try {
    ...
    s.sharedClientState.addPendingMutation(t.batchId),
      ...
      await Ia(s, t.changes),
      await Ro(s.remoteStore);
  } catch (t) {
    ...
    e.targetChanges.forEach((t, e) => {
      ...
      s &&
        ...
        t.addedDocuments.size > 0
          ...
          ? B(s.$o)
          : t.removedDocuments.size > 0 && (B(s.$o), (s.$o = !1)));
    }),
      await Ia(n, t, e);
  } catch (t) {
    await Bi(t);
    ...
    s.Oo.forEach((n, s) => {
      ...
      (function (t, e) {
        ...
        n.queries.forEach((t, n) => {
          // Run global snapshot listeners if a consistent snapshot has been emitted.
          for (const t of n.listeners) t.ro(e) && (s = !0);
        }),
          s && Go(n);
      })(s.eventManager, e),
      t.length && s.Fo.Pr(t),
 ...
 */ async function la(t, e, n) {
  ...
  if (r) {
    ...
    const n = Sn().add(r),
      i = new Nn(ct.min(), /* targetChanges= */ new Map(), /* targetMismatches= */ new Tn(it), t, n);
    await ua(s, i),
    ...
    await Tr(s.localStore, e, /* keepPersistedTargetData */ !1)
      .then(() => ga(s, e, n))
      .catch(Bi);
}
...
async function da(t, e, n) {
  ...
  try {
    const t = await (function (t, e) {
      ...
      return n.persistence.runTransaction("Reject batch", "readwrite-primary", (t) => {
        ...
        return n.An.lookupMutationBatch(t, e)
          .next((e) => (B(null !== e), (s = e.keys()), n.An.removeMutationBatch(t, e)))
          .next(() => n.An.performConsistencyCheck(t))
          .next(() => n.Wn.vn(t, s));
      });
    })(
    ...
    // listen events.
    ma(s, e, n), _a(s, e), s.sharedClientState.updateMutationState(e, "rejected", n), await Ia(s, t);
  } catch (n) {
    await Bi(n);
  }
}
 ...
 */ async function wa(t, e) {
  ...
  try {
    const t = await (function (t) {
      const e = q(t);
      return e.persistence.runTransaction("Get highest unacknowledged batch id", "readonly", (t) =>
        e.An.getHighestUnacknowledgedBatchId(t)
      );
    })(n.localStore);
    if (-1 === t)
...
function pa(t, e, n) {
  for (const s of n)
    if (s instanceof Zo) t.qo.addReference(s.key, e), Ta(t, s);
...
function Ta(t, e) {
  ...
  t.Bo.get(n) || t.Lo.has(s) || ($("SyncEngine", "New document in limbo: " + n), t.Lo.add(s), Ea(t));
}
 ...
 */ function Ea(t) {
  for (; t.Lo.size > 0 && t.Bo.size < t.maxConcurrentLimboResolutions; ) {
    ...
    t.Lo.delete(e);
    const n = new St(dt.fromString(e)),
      s = t.Qo.next();
    t.Uo.set(s, new sa(n)),
      (t.Bo = t.Bo.insert(n, s)),
      ho(t.remoteStore, new ai(Re(ge(n.path)), s, 2 /* LimboResolution */, et.I));
  }
}
    ...
    (s.Oo.forEach((t, a) => {
      o.push(
        s.Go(a, e, n).then((t) => {
          if (t) {
            s.isPrimaryClient &&
              s.sharedClientState.updateQueryState(a.targetId, t.fromCache ? "not-current" : "current"),
              i.push(t);
    ...
    await (async function (t, e) {
      ...
      try {
        await n.persistence.runTransaction("notifyLocalViewChanges", "readwrite", (t) =>
          Gs.forEach(e, (e) =>
            Gs.forEach(e.kn, (s) => n.persistence.referenceDelegate.addReference(t, e.targetId, s)).next(() =>
              Gs.forEach(e.xn, (s) => n.persistence.referenceDelegate.removeReference(t, e.targetId, s))
            )
          )
        );
      } catch (t) {
 ...
 */ async function Pa(t, e) {
  const n = q(t),
    s = await Er(n.localStore, e.query, /* usePreviousResults= */ !0),
    i = e.view.ko(s);
...
async function va(t, e, n, s) {
  const i = q(t),
    r = await (function (t, e) {
      const n = q(t),
        s = q(n.An);
      return n.persistence.runTransaction("Lookup mutation documents", "readonly", (t) =>
        s.Zt(t, e).next((e) => (e ? n.Wn.vn(t, e) : Gs.resolve(null)))
      );
    })(
      // PORTING NOTE: Multi-Tab only.
      i.localStore,
  ...
  if ((xa(n), $a(n), !0 === e && !0 !== n.Wo)) {
    ...
    n.Mo.forEach((s, i) => {
      n.sharedClientState.isLocalQueryTarget(i)
        ? t.push(i)
        : (e = e.then(() => (ga(n, i), Tr(n.localStore, i, /*keepPersistedTargetData=*/ !0)))),
        lo(n.remoteStore, i);
    }),
      await e,
      await Sa(n, t),
...
async function Sa(t, e, n) {
  ...
  for (const t of e) {
    ...
    if (n && 0 !== n.length) {
      ...
      (e = await pr(s.localStore, n)), await oa(s, Da(n), t, /*current=*/ !1);
    }
    i.push(e);
  }
  return s.Fo.Pr(r), i;
...
async function Na(t, e, n, s) {
  ...
  if (i.Wo)
    ...
    switch (n) {
      case "current":
      case "not-current": {
        const t = await Ar(i.localStore),
          s = Nn.createSynthesizedRemoteEventForCurrentChange(e, "current" === n);
        await Ia(i, t, s);
        break;
      }

      case "rejected":
        await Tr(i.localStore, e, /* keepPersistedTargetData */ !0), ga(i, e, s);
        break;
...
/** Adds or removes Watch targets for queries from different tabs. */ async function ka(t, e, n) {
  ...
  if (s.Wo) {
    for (const t of e) {
      ...
      const e = await Ir(s.localStore, t),
        n = await pr(s.localStore, e);
      await oa(s, Da(e), n.targetId, /*current=*/ !1), ho(s.remoteStore, n);
    }
    ...
    for (const t of n)
      s.Mo.has(t) &&
        ...
        (await Tr(s.localStore, t, /* keepPersistedTargetData */ !1)
          .then(() => {
...
function xa(t) {
  const e = q(t);
  return (
    (e.remoteStore.remoteSyncer.applyRemoteEvent = ua.bind(null, e)),
    (e.remoteStore.remoteSyncer.getRemoteKeysForTarget = Ra.bind(null, e)),
    (e.remoteStore.remoteSyncer.rejectListen = la.bind(null, e)),
    (e.Fo.Pr = Qo.bind(null, e.eventManager)),
    (e.Fo.zo = Wo.bind(null, e.eventManager)),
    e
  );
}
...
function $a(t) {
  const e = q(t);
  return (
    (e.remoteStore.remoteSyncer.applySuccessfulWrite = fa.bind(null, e)),
    (e.remoteStore.remoteSyncer.rejectFailedWrite = da.bind(null, e)),
    e
  );
}
 ...
 */ function Fa(t, e, n) {
  ...
  (async function (t, e, n) {
    try {
      ...
      if (
        await (function (t, e) {
          const n = q(t),
            s = Gn(e.createTime);
          return n.persistence
            .runTransaction("hasNewerBundle", "readonly", (t) => n.Ye.getBundleMetadata(t, e.id))
      ...
      // has newer version.
      await Ia(t, o.In, /* remoteEvent */ void 0),
...
class Oa {
  ...
  async initialize(t) {
    (this.k = to(t.databaseInfo.databaseId)),
 ...
 */ class Ma extends Oa {
  ...
  async initialize(t) {
    await super.initialize(t),
      await Rr(this.localStore),
      await this.ta.initialize(this, t),
      // Enqueue writes from a previous session
      await $a(this.ta.syncEngine),
      await Ro(this.ta.remoteStore),
      // NOTE: This will immediately call the listener, so we make sure to
      // set it after localStore / remoteStore are started.
      await this.persistence.sn(
        () => (
          this.gcScheduler && !this.gcScheduler.started && this.gcScheduler.start(this.localStore), Promise.resolve()
        )
      );
  }
  Zo(t) {
  ...
  Yo(t) {
    const e = or(t.databaseInfo.databaseId, t.databaseInfo.persistenceKey),
      n = void 0 !== this.cacheSizeBytes ? vi.withCacheSize(this.cacheSizeBytes) : vi.DEFAULT;
    return new sr(
 ...
 */ class La extends Ma {
  ...
  async initialize(t) {
    ...
    this.sharedClientState instanceof Qr &&
      ...
      await this.persistence.sn(async (t) => {
        await Va(this.ta.syncEngine, t),
          this.gcScheduler &&
            (t && !this.gcScheduler.started ? this.gcScheduler.start(this.localStore) : t || this.gcScheduler.stop());
      });
  }
  Jo(t) {
    const e = Xr();
    if (!Qr.bt(e))
      throw new j(K.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
 ...
 */ class Ba {
  async initialize(t, e) {
    this.localStore ||
      ...
      (this.sharedClientState.onlineStateHandler = (t) => ha(this.syncEngine, t, 1 /* SharedClientState */)),
  ...
  createDatastore(t) {
    const e = to(t.databaseInfo.databaseId),
      n = ((s = t.databaseInfo), new Yr(s));
    var s;
  ...
  createRemoteStore(t) {
    return (
      ...
      (n = this.datastore),
      (s = t.asyncQueue),
      (i = (t) => ha(this.syncEngine, t, 0 /* RemoteStore */)),
      (r = zr.bt() ? new zr() : new Gr()),
      new ao(e, n, s, i, r)
    );
    var e, n, s, i, r;
  ...
  async lookup(t) {
    ...
    const e = await (async function (t, e) {
      const n = q(t),
        ...
        r = await n.ji("BatchGetDocuments", s, i),
        o = new Map();
      r.forEach((t) => {
        const e = is(n.k, t);
...
class Qa {
  constructor(t, e, n, s) {
    (this.asyncQueue = t),
      ...
      (this.deferred = s),
      (this.la = 5),
      (this.ur = new eo(this.asyncQueue, "transaction_retry" /* TransactionRetry */));
  }
  ...
  wa(t) {
    this.la > 0 && this._a(t)
      ? ((this.la -= 1), this.asyncQueue.enqueueAndForget(() => (this.fa(), Promise.resolve())))
  ...
  constructor(
    ...
    (this.authCredentials = t),
      ...
      this.authCredentials.start(n, async (t) => {
        $("FirestoreClient", "Received user=", t.uid), await this.authCredentialListener(t), (this.user = t);
      }),
  ...
  await e.initialize(n, s),
    ...
    t.setCredentialChangeListener((t) =>
      (async function (t, e) {
        ...
        n.Gr.add(3 /* CredentialChange */),
          await uo(n),
          s &&
            // Don't set the network status to Unknown if we are offline.
            n.Jr.set("Unknown" /* Unknown */),
          await n.remoteSyncer.handleCredentialChange(e),
          n.Gr.delete(3 /* CredentialChange */),
          await co(n);
      })(e.remoteStore, t)
    ),
...
async function Ha(t) {
  return (
    t.offlineComponents || ($("FirestoreClient", "Using default OfflineComponentProvider"), await Ga(t, new Oa())),
    t.offlineComponents
  );
}
...
async function Ja(t) {
  return (
    t.onlineComponents || ($("FirestoreClient", "Using default OnlineComponentProvider"), await za(t, new Ba())),
    t.onlineComponents
  );
}
...
async function ec(t) {
  const e = await Ja(t),
    n = e.eventManager;
  return (n.onListen = ra.bind(null, e.syncEngine)), (n.onUnlisten = aa.bind(null, e.syncEngine)), n;
}
        ...
        const r = new qa({
            next: (r) => {
              ...
              !a && r.fromCache
                ...
                : a && r.fromCache && s && "server" === s.source
                ? i.reject(
                    new j(
                      K.UNAVAILABLE,
...
function oc(t, e) {
  ...
  return (
    t.asyncQueue.enqueueAndForget(async () =>
      (async function (t, e, n) {
        try {
          const s = await Er(t, e, /* usePreviousResults= */ !0),
            i = new ea(e, s.zn),
            r = i.bo(s.documents),
        ...
        (this._authCredentials = (function (t) {
          ...
          switch (t.type) {
            case "gapi":
              ...
              return (
                B(!("object" != typeof e || null === e || !e.auth || !e.auth.getAuthHeaderValueForFirstParty)),
...
function Rc(t, e, n, s = {}) {
  ...
  if (
    ("firestore.googleapis.com" !== r.host &&
      r.host !== e &&
      O("Host has been set in both settings() and useEmulator(), emulator host will be used"),
    t._setSettings(
 ...
 */ class vc extends bc {
   ...
   */ get parent() {
    ...
    return t.isEmpty() ? null : new Pc(this.firestore, /* converter= */ null, new St(t));
  }
  withConverter(t) {
...
function Vc(t, e, ...n) {
  ...
  {
    if (!(t instanceof Pc || t instanceof vc))
      throw new j(
        K.INVALID_ARGUMENT,
        "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore"
      );
    const s = t._path.child(dt.fromString(e, ...n));
    return yc(s), new vc(t.firestore, /* converter= */ null, s);
  }
}
 ...
 */ function Sc(t, e) {
  if (((t = Tc(t, Ac)), _c("collectionGroup", "collection id", e), e.indexOf("/") >= 0))
    throw new j(
      K.INVALID_ARGUMENT,
...
function Dc(t, e, ...n) {
  if (
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (e = st.A()),
    _c("doc", "path", e),
    t instanceof Ac)
  ) {
    const s = dt.fromString(e, ...n);
    return gc(s), new Pc(t, /* converter= */ null, new St(s));
  }
  {
    if (!(t instanceof Pc || t instanceof vc))
      throw new j(
 ...
 */ function Cc(t, e) {
  return (
    ...
    (t instanceof Pc || t instanceof vc) &&
      (e instanceof Pc || e instanceof vc) &&
...
class $c {
  constructor() {
    (this._progressObserver = {}),
      (this._taskCompletionResolver = new Q()),
      (this._lastProgress = {
        taskState: "Running",
        totalBytes: 0,
        totalDocuments: 0,
    ...
    t._queue.enqueueAndForgetEvenWhileRestricted(async () => {
      try {
        await (async function (t) {
          ...
          const e = t + "main";
          await Hs.delete(e);
        })(or(t._databaseId, t._persistenceKey)),
          e.resolve();
      } catch (t) {
        e.reject(t);
      }
 ...
 */ class su {
  ...
  constructor(t, e) {
    if (!isFinite(t) || t < -90 || t > 90)
      throw new j(K.INVALID_ARGUMENT, "Latitude must be a number between -90 and 90, but was: " + t);
...
/** The result of parsing document data (e.g. for a setData call). */ class ru {
  ...
  toMutation(t, e) {
    return null !== this.fieldMask
      ? new on(t, this.data, this.fieldMask, e, this.fieldTransforms)
      : new rn(t, this.data, e, this.fieldTransforms);
  }
}
...
class fu extends nu {
  _toFieldTransform(t) {
    if (2 /* MergeSet */ !== t.xa)
      throw 1 /* Update */ === t.xa
        ? t.Ua(`${this._methodName}() can only appear at the top level of your update data`)
        : t.Ua(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);
...
class _u extends nu {
  ...
  _toFieldTransform(t) {
    const e = du(this, t, /*array=*/ !0),
      n = this.Qa.map((t) => Eu(t, e)),
      s = new Be(n);
 ...
 */ function Eu(t, e) {
  if (
    ...
    return Ru("Unsupported field value:", e, t), Iu(t, e);
  if (t instanceof nu)
...
function Vu(t, e, n, s, i) {
  ...
  let c = "";
  return (
    (r || o) && ((c += " (found"), r && (c += ` in field ${s}`), o && (c += ` in document ${i}`), (c += ")")),
    new j(K.INVALID_ARGUMENT, a + t + c)
  );
}
   ...
   */ data() {
    if (this._document) {
      if (this._converter) {
        ...
        const t = new Cu(this._firestore, this._userDataWriter, this._key, this._document, /* converter= */ null);
    ...
    this._snapshot.docs.forEach((n) => {
      t.call(
        ...
        new $u(
          ...
          n.key,
          n,
          new ku(this._snapshot.mutatedKeys.has(n.key), this._snapshot.fromCache),
            ...
            if (t._snapshot.oldDocs.isEmpty()) {
              ...
              return t._snapshot.docChanges.map((n) => ({
                ...
                doc: new $u(
                  ...
                  n.doc.key,
                  n.doc,
                  new ku(t._snapshot.mutatedKeys.has(n.doc.key), t._snapshot.fromCache),
                  t.query.converter
                ),
                oldIndex: -1,
                newIndex: e++,
              ...
              return t._snapshot.docChanges
                ...
                .map((e) => {
                  const s = new $u(
                    ...
                    e.doc.key,
                    e.doc,
                    new ku(t._snapshot.mutatedKeys.has(e.doc.key), t._snapshot.fromCache),
                    t.query.converter
                  );
                  let i = -1,
                    r = -1;
                  return (
                    0 /* Added */ !== e.type && ((i = n.indexOf(e.doc.key)), (n = n.delete(e.doc.key))),
 ...
 */ function Mu(t, e) {
  return t instanceof xu && e instanceof xu
    ? t._firestore === e._firestore &&
        t._key.isEqual(e._key) &&
        (null === t._document ? null === e._document : t._document.isEqual(e._document)) &&
 ...
 * limitations under the License.
 */ function Lu(t) {
  if (pe(t) && 0 === t.explicitOrderBy.length)
...
class qu extends Bu {
  ...
  _apply(t) {
    const e = hu(t.firestore),
      n = (function (t, e, n, s, i, r, o) {
        let a;
        if (i.isKeyField()) {
          if ("array-contains" /* ARRAY_CONTAINS */ === r || "array-contains-any" /* ARRAY_CONTAINS_ANY */ === r)
            throw new j(
              K.INVALID_ARGUMENT,
              `Invalid Query. You can't perform '${r}' queries on FieldPath.documentId().`
            );
          ...
          ("in" /* IN */ !== r && "not-in" /* NOT_IN */ !== r && "array-contains-any" /* ARRAY_CONTAINS_ANY */ !== r) ||
            sh(o, r),
            (a = Tu(n, e, o, /* allowArrays= */ "in" /* IN */ === r || "not-in" /* NOT_IN */ === r));
        ...
        return (
          (function (t, e) {
            ...
            if (null !== n)
              ...
              throw n === e.op
                ? new j(K.INVALID_ARGUMENT, `Invalid query. You cannot use more than one '${e.op.toString()}' filter.`)
                : new j(
                    K.INVALID_ARGUMENT,
...
function Yu(...t) {
  return new Hu("startAfter", t, /*before=*/ !1);
}
...
/** Helper function to create a bound from a document or fields */ function eh(t, e, n, s) {
  if (((n[0] = getModularInstance(n[0])), n[0] instanceof Du))
    return (function (t, e, n, s, i) {
      ...
      // results.
      for (const n of Ae(t))
        if (n.field.isKeyField()) r.push(Ot(e, s.key));
        else {
      ...
      for (let r = 0; r < i.length; r++) {
        ...
        if (o[r].field.isKeyField()) {
          if ("string" != typeof c)
            throw new j(
              K.INVALID_ARGUMENT,
              `Invalid query. Expected a string for document ID in ${s}(), but got a ${typeof c}`
            );
          if (!Ie(t) && -1 !== c.indexOf("/"))
            throw new j(
              K.INVALID_ARGUMENT,
              `Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to ${s}() must be a plain document ID, but '${c}' contains a slash.`
            );
          const n = t.path.child(dt.fromString(c));
          if (!St.isDocumentKey(n))
            throw new j(
              K.INVALID_ARGUMENT,
              `Invalid query. When querying a collection group and ordering by FieldPath.documentId(), the value passed to ${s}() must result in a valid document path, but '${n}' is not because it contains an odd number of segments.`
            );
          const i = new St(n);
          a.push(Ot(e, i));
        } else {
...
function nh(t, e, n) {
  if ("string" == typeof (n = getModularInstance(n))) {
    ...
    if (!St.isDocumentKey(s))
      throw new j(
        K.INVALID_ARGUMENT,
        `Invalid query. When querying a collection group by FieldPath.documentId(), the value provided must result in a valid document path, but '${s}' is not because it has an odd number of segments (${s.length}).`
      );
  ...
  throw new j(
    K.INVALID_ARGUMENT,
    `Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: ${pc(
      n
    )}.`
  );
}
 ...
 */ function sh(t, e) {
  if (!Array.isArray(t) || 0 === t.length)
    throw new j(K.INVALID_ARGUMENT, `Invalid Query. A non-empty array is required for '${e.toString()}' filters.`);
  if (t.length > 10)
    throw new j(
      K.INVALID_ARGUMENT,
 ...
 */ class rh {
  ...
  convertDocumentKey(t, e) {
    ...
    B(As(n));
    const s = new dc(n.get(1), n.get(3)),
      i = new St(n.popFirst(5));
    return (
      s.isEqual(e) ||
 ...
 */ class ch {
  ...
  set(t, e, n) {
    ...
    const s = uh(t, this._firestore),
      i = oh(s.converter, e, n),
      r = lu(this._dataReader, "WriteBatch.set", s._key, i, null !== s.converter, n);
    ...
    return (
      (r =
        "string" == typeof (e = getModularInstance(e)) || e instanceof Zc
          ? pu(this._dataReader, "WriteBatch.update", i._key, e, n, s)
          : yu(this._dataReader, "WriteBatch.update", i._key, e)),
      this._mutations.push(r.toMutation(i._key, Je.exists(!0))),
      this
    );
  }
  /**
 ...
 */ function fh(t) {
  ...
  const e = Tc(t.firestore, Oc),
    n = Bc(e),
    s = new lh(e);
  return ic(n, t._key).then(
    (n) => new xu(e, s, t._key, n, new ku(null !== n && n.hasLocalMutations, /* fromCache= */ !0), t.converter)
  );
}
...
function yh(t, e, n, ...s) {
  ...
  o =
    "string" ==
      ...
      ? pu(r, "updateDoc", t._key, e, n, s)
      : yu(r, "updateDoc", t._key, e);
 ...
 */ function Th(t, e) {
  const n = Tc(t.firestore, Oc),
    s = Dc(t),
    i = oh(t.converter, e);
  return Ah(n, [
    lu(hu(t.firestore), "addDoc", s._key, i, null !== t.converter, {}).toMutation(s._key, Je.exists(!1)),
  ]).then(() => s);
}
...
function Eh(t, ...e) {
  ...
  return (function (t, e, n, s) {
    const i = new qa(s),
      r = new zo(e, i, n);
    return (
      t.asyncQueue.enqueueAndForget(async () => Ko(await ec(t), r)),
      () => {
 ...
 */ class Ph extends class {
  ...
  set(t, e, n) {
    const s = uh(t, this._firestore),
      i = oh(s.converter, e, n),
      r = lu(this._dataReader, "Transaction.set", s._key, i, null !== s.converter, n);
  ...
  update(t, e, n, ...s) {
    ...
    return (
      (r =
        "string" == typeof (e = getModularInstance(e)) || e instanceof Zc
          ? pu(this._dataReader, "Transaction.update", i._key, e, n, s)
          : yu(this._dataReader, "Transaction.update", i._key, e)),
      ...
      .then(
        (t) =>
          new xu(
            ...
            e._key,
            t._document,
            new ku(/* hasPendingWrites= */ !1, /* fromCache= */ !1),
            e.converter
          )
      );
  }
      ...
      new Component(
        ...
        (t, { options: n }) => {
          const s = t.getProvider("app").getImmediate(),
            i = new Oc(s, new H(t.getProvider("auth-internal")), new Z(t.getProvider("app-check-internal")));
          return (
            (n = Object.assign(
              {
                useFetchStreams: e,
...
export {
  ...
  eu as Bytes,
  Fc as CACHE_SIZE_UNLIMITED,
  vc as CollectionReference,
  Pc as DocumentReference,
  ...
  O as _logWarn,
  mc as _validateIsNotUsedTogether,
  Th as addDoc,
  Dh as arrayRemove,
  Sh as arrayUnion,
  Qc as clearIndexedDbPersistence,
  Vc as collection,
  Sc as collectionGroup,
  Rc as connectFirestoreEmulator,
  ph as deleteDoc,
  vh as deleteField,
  zc as disableNetwork,
  Dc as doc,
  tu as documentId,
  qc as enableIndexedDbPersistence,
  Kc as enableMultiTabIndexedDbPersistence,
  Gc as enableNetwork,
  th as endAt,
  Zu as endBefore,
  Bc as ensureFirestoreConfigured,
  Ah as executeWrite,
  hh as getDoc,
